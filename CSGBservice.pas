...
type
  ...
  ['{BAF09A16-C601-BE75-CF3C-640BC3A39E57}']
    ...
    function  isyeriBilgisiSOAP(const isyeriSgk: string; const iguTc: string): isyeriCevapDVO; stdcall;
    ...
    function  egitimKaydetSOAP(const egitimBilgisi: egitimBilgisi; const imzaliDeger: string; const imzalananXML: string): egitimBilgisiCevap; stdcall;
    ...
    function  egitimSorgula(const sorguNo: string): ArrayOfEgitimBilgisiCevap; stdcall;
  end;
