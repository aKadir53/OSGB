...
begin
  ...
  bHataOldu := False;
  BeginTrans (datalar.ADO_SQL3);
  try
    //transaction sayýsýný sakla.
    iBaslangicTranCount := TranCount(datalar.ADO_SQL3);
        ...
        begin
          try
            ...
            begin
              ...
              iIslemTranCount := TranCount(datalar.ADO_SQL3);
