...
procedure TfrmMerkezBilgisi.ButtonClick(Sender: TObject);
var
  F : TGirisForm;
...
procedure TfrmMerkezBilgisi.OrtakEventAta(Sender : TObject);
begin
...
procedure TfrmMerkezBilgisi.OrtakEventAta(Sender : TcxImageComboKadir);
begin
...
procedure TfrmMerkezBilgisi.txtAktifPropertiesChange(Sender: TObject);
var
...
begin
   ...
   then begin
       ...
       sql := 'update MerkezBilgisi set aktif = ' + #39 + _aktif + #39 +
...
procedure TfrmMerkezBilgisi.txtNaceKodPropertiesButtonClick(Sender: TObject;
  AButtonIndex: Integer);
var
...
procedure TfrmMerkezBilgisi.PropertiesEditValueChanged(
  Sender: TObject);
begin
  inherited;
...
procedure TfrmMerkezBilgisi.txtTipPropertiesChange(Sender: TObject);
begin
  inherited;
      (*
...
function TfrmMerkezBilgisi.TakipSil;
begin
//
end;

procedure TfrmMerkezBilgisi.FotoNewRecord;
var
 sql,dosyaNo : string;
 ado : TADOQuery;
begin
...
procedure TfrmMerkezBilgisi.FotoDeleteRecord;
var
 sql,dosyaNo : string;
 ado : TADOQuery;
begin
...
procedure TfrmMerkezBilgisi.cxEditEnter(Sender: TObject);
begin
  inherited;
  //
...
procedure TfrmMerkezBilgisi.cxEditExit(Sender: TObject);
begin
  inherited;
  //
...
procedure TfrmMerkezBilgisi.cxGridGelislerDblClick(Sender: TObject);
begin
  inherited;
    SeansKart1.Click;
end;

procedure TfrmMerkezBilgisi.cxGridGelislerKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
...
procedure TfrmMerkezBilgisi.cxTextEditBKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
   inherited;
  // if key  then
...
procedure TfrmMerkezBilgisi.DOGUMTARIHIPropertiesValidate(Sender: TObject;
  var DisplayValue: Variant; var ErrorText: TCaption; var Error: Boolean);
begin
  inherited;
//
...
procedure TfrmMerkezBilgisi.FirmaSubeBirlestir;
var
  List: TListeAc;
...
procedure TfrmMerkezBilgisi.seansGunleriPropertiesEditValueChanged(Sender: TObject);
begin
  inherited;
...
procedure TfrmMerkezBilgisi.cxButtonCClick(Sender: TObject);
var
 List : TListeAc;
