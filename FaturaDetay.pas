...
begin
 ...
 // TopPanel.Visible := true;
  ...
  List := ListeAcCreate('SIRKETLER_TNM','sirketKod,tanimi,SGKKod,VN,Aktif',
                       'SirketKod,Sirket,SatýcýKod,VergiNo,Durum',
                       '50,250,80,80,50','SirketKod','Firma Listesi','',5,True);
