...
begin
  ...
  case TControl(sender).Tag  of
    ...
    2 : begin
          TcxTextEditKadir(FindComponent('hazirlayan')).EditValue := datalar.username;
...
begin
     ...
     SahaGozetimGrid.Dataset.Refresh;
   //  FaturaToplamlari;
...
begin
  ...
  -24:begin
        ...
        if mrYes = ShowPopupForm('Saha Gözetim Paylaþ',sahaGozetimPaylas)
        then begin
...
begin
 ...
 // TopPanel.Visible := true;
  ...
  where := ' hazirlayan = ' + QuotedStr(datalar.username) + ' or paylasilan = ' + QuotedStr(datalar.username);
...
//  setDataStringBLabel(self,'bosSatir',kolon1,'',1000,'Risk Kaynaklarý');
  setDataStringKontrol(self,SahaGozetimGrid,'SahaGozetimGrid','',Kolon1,'',1050,465);
