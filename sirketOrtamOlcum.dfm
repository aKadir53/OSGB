object frmSirketOrtamOlcum: TfrmSirketOrtamOlcum
  Left = 1
  Top = 1
  Caption = 'Ortam '#214'l'#231#252'm'
  ClientHeight = 597
  ClientWidth = 1000
  Color = clBtnFace
  ...
  object OrtamOlcumGrid: TcxGridKadir
    ...
    object Satirlar: TcxGridDBBandedTableView
      ...
      Bands = <
        item
          Caption = 'Ortam '#214'l'#231#252'mleri'
          FixedKind = fkLeft
      ...
      object SatirlarColumn1: TcxGridDBBandedColumn
        ...
        DataBinding.FieldName = 'OlcumAdi'
      ...
      object SatirlarColumn4: TcxGridDBBandedColumn
      ...
      object SatirlarColumn5: TcxGridDBBandedColumn
        Caption = 'Normal Deger'
        DataBinding.FieldName = 'NormalDeger'
        PropertiesClassName = 'TcxTextEditProperties'
        Properties.Alignment.Horz = taCenter
        Properties.Alignment.Vert = taVCenter
        HeaderAlignmentHorz = taCenter
    ...
    object OrtamOlcumGridLevel1: TcxGridLevel
      GridView = Satirlar
    end
  end
